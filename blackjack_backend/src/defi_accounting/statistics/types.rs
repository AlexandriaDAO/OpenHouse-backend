...
pub struct DailySnapshot {
    ...
    /// Pool reserve at end of day (ckUSDT with 6 decimals, divide by 1_000_000 for USDT)
    pub pool_reserve_end: u64,
    /// Day's profit/loss - SIGNED to handle negative days (ckUSDT with 6 decimals)
    pub daily_pool_profit: i64,
    /// Total wagered that day (ckUSDT with 6 decimals)
